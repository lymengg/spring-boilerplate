...
public class ExpenseMapper {
    ...
    public ExpenseResponse toResponse(Expense expense) {
        return ExpenseResponse.builder()
                ...
                .ownerEmail(expense.getOwner() != null ? expense.getOwner().getEmail() : null)
                ...
                .approvedByEmail(expense.getApprovedBy() != null ? expense.getApprovedBy().getEmail() : null)
                .rejectedById(expense.getRejectedBy() != null ? expense.getRejectedBy().getId() : null)
                .rejectedByEmail(expense.getRejectedBy() != null ? expense.getRejectedBy().getEmail() : null)
                .processedById(expense.getProcessedBy() != null ? expense.getProcessedBy().getId() : null)
                .processedByEmail(expense.getProcessedBy() != null ? expense.getProcessedBy().getEmail() : null)
