...
public class LoginService {
    ...
    /**
     * Verifies credentials through Spring Security, applies account lockout rules,
     * and issues either an MFA challenge or a token response, never both.
     */
    @Transactional
    ...
    /**
     * Rate-limits per-user MFA verify attempts and requires a valid pending
     * session token before issuing tokens, preventing brute-force of MFA codes.
     */
    @Transactional
