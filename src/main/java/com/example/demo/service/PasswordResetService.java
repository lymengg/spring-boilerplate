...
public class PasswordResetService {
    ...
    /**
     * Rate-limits per email and hashes the raw token before storage, so the
     * actual reset token never persists and cannot be leaked from the database.
     */
    @Transactional
    ...
    /**
     * Validates the token, enforces rate limits, updates the password, revokes
     * existing refresh tokens, and marks the token as used to prevent replay.
     */
    @Transactional
    ...
    /**
     * Periodic cleanup of expired/used tokens, keeping the password reset token
     * table small without impacting the user-facing flow.
     */
